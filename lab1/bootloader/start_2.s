...
start32:
	...
	# TODO:输出Hello World
	movw $0x0448,%gs:0x500
	movw $0x0465,%gs:0x502
	movw $0x046C,%gs:0x504
	movw $0x046C,%gs:0x506
	movw $0x046F,%gs:0x508
	movw $0x042C,%gs:0x50a
	movw $0x0420,%gs:0x50c
	movw $0x0457,%gs:0x50e
	movw $0x046F,%gs:0x510
	movw $0x0472,%gs:0x512
	movw $0x046C,%gs:0x514
	movw $0x0464,%gs:0x516
	movw $0x0421,%gs:0x518
	movw $0x0400,%gs:0x51a
